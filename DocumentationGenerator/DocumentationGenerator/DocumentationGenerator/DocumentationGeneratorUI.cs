...
namespace DocumentationGenerator
{
   public partial class DocumentationGeneratorUI : Form
   {
      ...
      private void ProjectWasReadEventProc(ObjectLibrary.Project theProject)
      {
         ...
         string nbObjects = "0";
         string langage = "Unkown";

         if (theProject != null)
         {
            projectName = theProject.ProjectName;
            langage = theProject.UsedLangage.ToString();
         }

         if (theProject.Objects != null)
         {
            nbObjects = theProject.Objects.Count.ToString();
         }

         ListViewItem nextAddedItem = new ListViewItem(new string[]{projectName, langage, nbObjects, "0", "0"});
